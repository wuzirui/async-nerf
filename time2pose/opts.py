...
def get_opts_base():
    ...
    parser.add_argument('--n_layers', type=int, default=10, help='num of hidden layers in multi-layer perceptron')
    ...
    parser.add_argument('--t_embedding_freq', type=int, default=5, help='positional encoding for timestamps')
